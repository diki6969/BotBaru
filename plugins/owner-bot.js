...
let handler = async(m, { conn }) => {
	...
	await delay(100)
  return conn.sendMessage(m.chat, { text: `_Halo Kak @${await m.sender.split('@')[0]}, Itu Nomer Owner Cantik ku, Chat Aja Tapi Chat P ga Bakal di Balas_`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
