...
//Info maszeh
global.owner = ["6285609188523"]
global.mods = ["6285609188523"]

global.namabot = '𝙄𝙠𝙮𝙮𝘽𝙤𝙩' //nama BOT Lu
global.packname = '𝙄𝙠𝙮𝙮𝘽𝙤𝙩'
global.author = '𝐈𝐤𝐲𝐲𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥' //nama Owner
global.ownernya = ["6285609188523"]
global.linkyt = 'https://' //link yt lu
global.linkig = 'https://' //link ig
global.linkgh = 'https://github.com/xynabotz' //jangan di hapus nanti error"
global.titlebot = `⫹⫺ WhatsApp Bot | By 𝙄𝙠𝙮𝙮𝘽𝙤𝙩`
global.wm2 = '𝙄𝙠𝙮𝙮𝘽𝙤𝙩' //ganti aja kalau mau
global.wm = '𝙄𝙠𝙮𝙮𝘽𝙤𝙩'
global.colong1 = 'Hayoo Ngapain'
global.colong2 = '𝙄𝙠𝙮𝙮𝘽𝙤𝙩シ︎'
global.kontak2 = [
['6285609188523', '𓂺', '𝐈𝐤𝐲𝐲𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥', 'Sᴀᴠᴇ Aᴊᴀ Yᴇ Oᴡɴᴇʀ Kᴜ Bᴀɪᴋ Kᴏᴋ', true],
]

//Biodata OWNER Bre
global.ML = 'SUSAH MANIAC︎' //Akun ML lu
global.gender = 'PRIA' //jenis kelamin lu
global.agama = 'ISLAM BROTHER' //agama lu
global.age = '15' //usia lu sekarang
global.kelas = '10' //kelas lu
global.hobi = 'tikok/turu/ngegame' //hobi lu bre
global.tempat = 'Lampung , Lampung Tengah' //tempat tinggal lu
